...
//conditional rendering PrivateRouter component
...
//- while still logout, click on Create Expense tab it will not render becos of the Create
//Expense is now PrivateRoute and isAuthenticated is false.
//- delete the Header component on AppRouter.js also remove it usage as well.
//- import Header from '../components/Header'; onto PrivateRoute.js file and add it to the true
//part of the ternary operator like this
// (
//     <div>
//       <Header />
//       <Component {...props} />
...
// its stall on the other components when you login beco's we have added to the PrivateRoute
//component.
